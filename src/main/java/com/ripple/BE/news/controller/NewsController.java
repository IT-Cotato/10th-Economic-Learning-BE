...
import com.ripple.BE.news.application.NewsService;
...
public class NewsController {
    ...
    public ResponseEntity<ApiResponse<Object>> getNewsList(
        ...
        NewsPreviewListResponseDTO newsList =
                newsService.getNewsList(page, sort, category, currentUser.getId());

        return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.from(newsList));
    }
    ...
    public ResponseEntity<ApiResponse<Object>> getNews(
        ...
        NewsResponseDTO newsDTO = newsService.getNews(id, currentUser.getId());
        return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.from(newsDTO));
    }
